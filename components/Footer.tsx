        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex flex-col items-center">
              <Image src={ecellLogoWhite} width={150} height={180} alt="logo" />
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 lg:grid-cols-3">
            <div>
              <p className="font-semibold text-base">Organisation</p>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-base text-white">
                <div className="flex gap-2 items-center">
                  ...
                  <span>Shubharanjan Deori & Raunak Pal</span>
                </div>
                <div className="flex gap-2 items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>+91 8850322408, +91 8100196134</span>
                </div>
              </nav>
            </div>
            <div>
              <p className="font-medium"></p>
              <nav className="flex flex-col space-y-2 text-base text-white">
                <a
                  className="hover:opacity-75"
                  target="_blank"
                  rel="noreferrer"
